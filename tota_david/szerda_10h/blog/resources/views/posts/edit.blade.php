                ...
                @forelse ($categories as $category)
                    <div class="form-check">
                        <input
                            ...
                            @checked(
                                in_array(strval($category->id), old('categories', $post->categories->pluck('id')->toArray())))
                            )
                        >
                        {{-- TODO --}}
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div id="cover_preview" class="col-12">
                            ...
                            <img id="cover_preview_image" src="{{ asset('images/default_post_cover.jpg') }}" alt="Cover preview" width="350px">
                        </div>
                    </div>
                </div>
            </div>
